...
describe('NotificationService', () => {
	...
	it('should show all notifications ', (done) => {
		...
		notiService.notifications.pipe(bufferCount(notifications.length)).subscribe((n) => {
	...
	it('should remove existing notification ', (done) => {
		...
		notiService.notifications.pipe(bufferCount(notifications.length - 1)).subscribe((n) => {
